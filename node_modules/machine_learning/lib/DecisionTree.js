...
DecisionTree.prototype.getDepth = function()
{
    var self = this;
    return getTreeDepth(self.tree, 0 );
}
...
function getTreeDepth(tree, depth )
{
    ...
    {
        var leftDepth = getTreeDepth( tree.tb, depth ) + 1;
        var rightDepth = getTreeDepth( tree.fb, depth) + 1;
...
function printTree(tree,indent) {
    ...
    if(typeof tree.results !== 'undefined')
    {
        for( var i = 0; i < indent.lenght; ++i )
            console.log( ' ' );
        console.log(tree.results);
    }
    else {
        // print condition
        console.log(indent + tree.col+':'+tree.value+'? ');
